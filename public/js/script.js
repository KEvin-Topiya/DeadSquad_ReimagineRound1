...
const color=[
    ...
    {//green
        ...
        color2:"#B3DD6F",
        color3:"#D8FBA2",
        html:"<p class='ptext font-f1 text-[4rem] '>CREAMY  <b class='font-black'>FUN</b><br/>&nbsp;WITH <b>ONION</b> MASALA </p></div>"
    },
    {//blue
        ...
        color2:"#65A0FF",
        color3:"#BAD5FF",
        html:" <p class='ptext font-f1 text-[4rem] '>MASALA ZING FOR YOU <br/>&nbsp;<b>TEA TIME CONVERSITION</b></p></div> "
    },
    {//yellow
        ...
        color2:"#FBD775",
        color3:"#FEE397",
        html:" <p class='ptext font-f1 text-[4rem] '>CHATPATA <b class='font-black'> GOSSIP</b> &<br/>&nbsp;CHATPATA <b>NIMBU</b></p></div>"
    },
